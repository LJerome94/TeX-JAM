...
\renewcommand{\AA}{\mathring{\mathrm{A}}}
...
\newcommand{\kb}{k_\mathrm{B}} % Boltzmann's constant.
% \renewcommand{\c}{\mathrm{c}} % Fermionic annihilation operator.
\let\oldAA\AA
\renewcommand{\r}{\mathbf{r}} % Position vector.
\renewcommand{\k}{\mathbf{k}} % Wave vector.
